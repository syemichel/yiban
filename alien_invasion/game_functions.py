...
def check_events(stats,play_button,ai_settings,ship,screen,aliens,bullets):
    for event in pygame.event.get():
        if event.type ==pygame.QUIT:
            ...
            check_play_button(stats,play_button,mouse_x,mouse_y,ai_settings,ship,screen,aliens,bullets)
...
def update_aliens(ai_settings,aliens,ship,stats,bullets,screen):
    ...
    check_aliens_bottom(screen,aliens,ai_settings,ship,stats,bullets)
...
def ship_hit(ai_settings,aliens,ship,stats,bullets,screen):
    stats.ships_left -=1
    aliens.empty()
    bullets.empty()
    create_fleet(ai_settings,screen,ship,aliens)
...
def check_aliens_bottom(screen,aliens,ai_settings,ship,stats,bullets):
